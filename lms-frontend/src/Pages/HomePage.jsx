      ...
      <div className="pt-10 text-white flex items-center justify-center gap-10 mx-16 h-[90vh]">
        <div className="w-1/2 space-y-6"> 
          ...
          <div className="space-x-6">
              ...
              <Link to="/contact">
                <button className="border border-yellow-500 py-3 px-5 rounded-md font-semibold text-lg coursor-pointer hover:bg-yellow-600 transition-all ease-in-out duration-300">
                  Contact Us
                </button>
              </Link>
          </div>
