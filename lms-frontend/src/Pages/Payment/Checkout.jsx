...
function Checkout() {
  ...
  const fullRazorpayState = useSelector((state) => state?.razorpay);
  ...
  // console.log("razorpayKey updated:", razorpayKey);
  // console.log("Full razorpay state:", fullRazorpayState);
  // }, [subscriptionId, razorpayKey, fullRazorpayState]);
